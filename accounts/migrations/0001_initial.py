...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('design_stats', models.JSONField(default=dict)),
            ],
        ),
        migrations.CreateModel(
            name='FactoryDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('FACTORY', 'Factory Partner'), ('DESIGNER', 'Designer'), ('BUYER', 'Buyer'), ('ADMIN', 'Admin')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('admin_level', models.CharField(choices=[('JUNIOR', 'Junior'), ('SENIOR', 'Senior'), ('SUPER_ADMIN', 'Super Admin')], default='JUNIOR', max_length=20)),
